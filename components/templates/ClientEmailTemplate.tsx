...
const ClientEmailTemplate = ({ name, message }: ClientEmailTemplateProps) => {
  return (
    <Html lang='en'>
      <Container>
        <Section>
          <Heading as='h1'>Thank you for reaching out, {name}!</Heading>
          <Text>We have received your message and will get back to you shortly.</Text>
          <Text>Here is a copy of your message:</Text>
          <Text>{message}</Text>
          <Text>
            Best regards,
            <br />
